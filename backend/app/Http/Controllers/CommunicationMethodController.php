...
class CommunicationMethodController extends Controller
{
     ...
     *     description="Devuelve una lista de todos los métodos de comunicación disponibles. Acceso: user, admin, therapist.",
     *     security={{"bearerAuth":{}}},
     *     @OA\Response(
     *         response=200,
     ...
     *     description="Devuelve la información de un método de comunicación específico. Acceso: user, admin, therapist.",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *         name="methodId",
     *         in="path",
    ...
    public function show(int $methodId): JsonResponse
    {
        try {
            ...
            return response()->json(['data' => $method->toArray()]);
        } catch (\Exception $e) {
     ...
     *     description="Crea un nuevo método de comunicación con un nombre único. Acceso: admin, therapist.",
     *     security={{"bearerAuth":{}}},
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     ...
     *     description="Actualiza el nombre de un método de comunicación existente. Acceso: admin, therapist.",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *         name="methodId",
     *         in="path",
    ...
    public function update(Request $request, int $methodId): JsonResponse
    {
        ...
        try {
            $newMethodName = $payload['method_name'];
     ...
     *     description="Elimina permanentemente un método de comunicación por su ID. Acceso: admin, therapist.",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *         name="methodId",
     *         in="path",
     ...
     *         @OA\Schema(type="integer", example=1)
     *     ),
     *     @OA\Response(response=204, description="Método eliminado con éxito."),
     *     @OA\Response(response=404, description="Método no encontrado.")
     * )
     */
